      ...
      >
        <View style={styles.periodTabs}>
          <TouchableOpacity
            style={[
              styles.periodTab,
              selectedPeriod === "weekly" && styles.periodTabActive,
            ]}
          ...
          >
            <Text
              style={[
                ...
                selectedPeriod === "weekly" && styles.periodTabTextActive,
              ]}
            >
              Weekly
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.periodTab,
              selectedPeriod === "monthly" && styles.periodTabActive,
            ]}
          ...
          <TouchableOpacity
            style={[
              styles.periodTab,
              selectedPeriod === "yearly" && styles.periodTabActive,
            ]}
        ...
        <View style={styles.card}>
          <View style={styles.cardHeader}>
            ...
            <Text style={styles.cardSubtitle}>
              85% of viewers watch to the end
            </Text>
          </View>
          ...
          <View style={styles.chartContainer}>
            <View style={styles.chartYAxis}>
              {["500k", "400k", "300k", "200k", "100k", "0"].map((val, idx) => (
                <Text key={idx} style={styles.chartYLabel}>
                  {val}
                </Text>
              ))}
            </View>
            <View style={styles.chartArea}>
              <View style={styles.chartLine}>
                {[70, 40, 30, 55, 15, 45, 35, 65, 68, 75, 50, 25, 60, 62].map(
                  (height, idx) => (
              ...
              >
                ...
                <View style={styles.topShortOverlay}>
                  ...
                  <View style={styles.topShortViews}>
                    ...
                    <Text style={styles.topShortViewsText}>
