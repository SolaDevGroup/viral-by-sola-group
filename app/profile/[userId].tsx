            ...
            <View style={styles.bannerTopRight}>
              ...
              >
                <BlurView
                  ...
                  style={styles.bannerIconBlur}
                />
                <Image source={Images.noti} style={{ height: 20, width: 20 }} />
              </TouchableOpacity>
            </View>
          </View>
          ...
          <View style={styles.bannerBottomBar}>
            ...
            <View style={styles.gradientBlurContainer}>
              <BlurView
                intensity={0}
                tint="regular"
                style={[styles.gradientBlurLayer, { height: "35%", top: 0 }]}
              />
          ...
          >
            ...
            >
              <View style={[styles.adCardContent, { marginLeft: 12 }]}>
                <Text style={styles.adCardTitle}>Subscribe for $19.90/mo</Text>
              </View>
