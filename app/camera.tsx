      ...
      if (Platform.OS !== "web") {
        ...
        if (video) {
          ...
          if (mode === "short") {
            ...
            router.push(
              `/trim-video?videoUri=${encodeURIComponent(
                video.uri
              )}&mode=${mode}` as Href
            );
          }
    ...
    try {
      if (Platform.OS !== "web") {
        ...
        if (photo) {
          ...
          router.push(
            `/post-video?mediaUri=${encodeURIComponent(
              photo.uri
            )}&mode=story&type=photo` as Href
          );
        }
      } else {
          ...
          <View style={styles.modeSelector}>
            ...
            >
              <Text
                style={[
                  styles.modeText,
                  mode === "short" && styles.modeTextActive,
                ]}
              >
                Short
              </Text>
            ...
            >
              <Text
                style={[
                  styles.modeText,
                  mode === "live" && styles.modeTextActive,
                ]}
              >
                Live
              </Text>
