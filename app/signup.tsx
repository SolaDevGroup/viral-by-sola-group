      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerTitleContainer}>
          <Text style={styles.headerTitle}>
            {step === "verify" ? "Confirm your number" : "Create account"}
          </Text>
          {step !== "verify" && (
        ...
        {step === "phone" && (
          <View style={styles.stepContainer}>
            ...
            <Text style={styles.disclaimer}>
              We&apos;ll send you a verification code. By entering your number,
              you agree to receive transactional messaging by SMS or other
              message channel about your account.{" "}
              <Text style={styles.disclaimerLink}>Learn more</Text> about how
              Viral uses your phone number.
            </Text>
          </View>
        )}
