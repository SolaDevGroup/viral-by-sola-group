          ...
          >
            <View style={styles.creatorSection}>
              ...
              >
                ...
                <View
                  style={[styles.crownBadge, { backgroundColor: accentColor }]}
                >
            ...
            <View style={styles.plansContainer}>
              ...
              >
                ...
                <Text
                  style={[
                    styles.planPrice,
                    selectedPlan === "monthly" && { color: accentColor },
                  ]}
                >
              ...
              >
                <View
                  style={[styles.saveBadge, { backgroundColor: accentColor }]}
                >
                ...
                <Text
                  style={[
                    styles.planPrice,
                    selectedPlan === "yearly" && { color: accentColor },
                  ]}
                >
