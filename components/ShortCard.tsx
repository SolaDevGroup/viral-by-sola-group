...
export default function ShortCard({
  ...
  useEffect(() => {
    if (Platform.OS === "web") {
      if (isActive && webVideoRef.current) {
        webVideoRef.current
          .play()
          .catch((err) => console.log("Web video play error:", err));
      ...
      if (isActive) {
        ...
        videoRef.current
          ?.pauseAsync()
          .catch((err) => console.log("Video pause error:", err));
      }
    }
  }, [isActive]);
  ...
  useEffect(() => {
    ...
    return () => {
      if (Platform.OS === "web" && webVideo) {
        ...
        nativeVideo
          ?.pauseAsync()
          .catch((err) => console.log("Video cleanup error:", err));
      }
    };
  }, []);
  ...
  return (
    <Pressable
      style={[styles.container, { height: cardHeight, width: SCREEN_WIDTH }]}
    ...
    >
        ...
        <View style={styles.membershipOverlay}>
          <View style={styles.membershipContent}>
            ...
            <Text style={styles.membershipSubtitle}>
              Subscribe to @{short.user.username} to unlock this exclusive
              content
            </Text>
            <TouchableOpacity
        ...
        <View style={styles.headerRow}>
          ...
          >
            <View style={{ marginTop: 5, marginLeft: 8, marginRight: 6 }}>
              <AnimatedCircle size={47} strokeWidth={3} gap={4} duration={2000}>
                {short.user.avatar ? (
                  <Image
                    source={{ uri: short.user.avatar }}
                    style={styles.avatar}
                  />
                ) : (
              ...
              <View style={styles.sponsoredBadge}>
                {Platform.OS !== "web" ? (
                  <BlurView
                    intensity={16}
                    tint="dark"
                    style={styles.sponsoredBadgeBlur}
                  >
          ...
          <View style={styles.viewsBadgeWrapper}>
            {Platform.OS !== "web" ? (
              <BlurView
                intensity={16}
                tint="dark"
                style={[styles.viewsBadge, isLive && styles.viewsBadgeLive]}
              >
                <Image
                  source={Images.eye}
              ...
              <View
                style={[
                  styles.viewsBadge,
                  styles.viewsBadgeWeb,
                  isLive && styles.viewsBadgeLive,
                ]}
              >
                <Image
                  source={Images.eye}
      ...
      {!isMembership && (
        ...
        >
          ...
          {!isAd && (
            <>
              <View style={[styles.actionsRow, { marginBottom: 14 }]}>
                <TouchableOpacity
                    ...
                    >
                      <Image
                        ...
                        style={{
                          height: 20,
                          width: 20,
                          tintColor: colors.whiteOpacity48,
                        }}
                      />
