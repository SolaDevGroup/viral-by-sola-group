...
export default function ProfileScreen() {
  const { user, isDarkMode, accentColor, setAccentColor, toggleDarkMode } =
    useApp();
  ...
  const { isVisitor } = useLocalSearchParams();
  ...
  const [editBio, setEditBio] = useState(
    user?.bio || "Creating viral content daily ✨ Views > Everything"
  );
  ...
  useEffect(() => {
    const banner = userData?.profile?.banner;

    if (banner) {
      setCustomBanner(banner);

      // fallback: infer from file extension
      const isVideo = /\.(mp4|mov|webm|mkv)$/i.test(banner);
  ...
  const getVisibilityIcon = () => {
    switch (visibility) {
      case "private":
        return <Lock size={20} color={theme.text} strokeWidth={2} />;
      case "followers":
        return <Users size={20} color={theme.text} strokeWidth={2} />;
      case "subscribers":
        return <DollarSign size={20} color={theme.text} strokeWidth={2} />;
      case "public":
        return (
          <Image
            source={Images.list}
          ...
          />
        ); // <Globe size={20} color={theme.text} strokeWidth={2} />;
      default:
        return (
          <Image
            source={Images.grid}
  ...
  const pickImage = async (type?: any) => {
    try {
      ...
      if (!result.canceled && result.assets[0]) {
        ...
        console.log("Image selected:", uploadedUrl);
        setBannerType("image");
        setCustomBanner(uploadedUrl);
    ...
    try {
      ...
      if (!result.canceled && result.assets[0]) {
        const uploadRes = await uploadFileGetUrl(
          { localUri: result.assets[0].uri, name: "banner-video.mp4" },
          "video/mp4"
        );
        setBannerType("video");
        const uploadedUrl =
  ...
  return (
    <View style={[styles.container, { backgroundColor: accentColor }]}>
      <Animated.ScrollView
        style={[styles.scrollView, { backgroundColor: accentColor }]}
        ...
        >
              ...
              <Image
                source={{
                  uri:
                    customBanner ||
                    user?.avatar ||
                    "https://images.unsplash.com/photo-1601814933824-fd0b574dd592?w=800&h=600&fit=crop",
                }}
                style={styles.bannerImage}
                resizeMode="cover"
              />
          ...
          <View style={styles.bannerBottomBar}>
            <LinearGradient
              colors={[
                "rgba(18, 18, 18, 0)",
                getColorWithOpacity(accentColor, 0.12),
                getColorWithOpacity(accentColor, 0.22),
                getColorWithOpacity(accentColor, 0.3),
                getColorWithOpacity(accentColor, 0.35),
              ]}
        ...
        >
          <View style={styles.nameSection}>
            ...
            <Text style={[styles.username, { color: theme.textSecondary }]}>
              @{user?.username || "jameswilson"}
            </Text>
          </View>
          <View style={styles.viralRow}>
            <Link2 size={16} color={theme.text} strokeWidth={2} />
            <Text style={[styles.viralLabel, { color: theme.text }]}>
              Viral
            </Text>
            <View
              style={[styles.viralDivider, { backgroundColor: theme.divider }]}
            />
            <Text style={[styles.latestLabel, { color: theme.textSecondary }]}>
              Latest Content
            </Text>
          </View>
          ...
          <View style={styles.viewsHighlight}>
            ...
            <Text style={[styles.viewsNumber, { color: theme.text }]}>
              {formatNumber(user?.totalViews || 45500000)}
            </Text>
            <Text style={[styles.viewsLabel, { color: theme.textSecondary }]}>
              Total Views
            </Text>
          </View>
          ...
          <Text style={[styles.bio, { color: theme.textSecondary }]}>
            {user?.bio ||
              "Hi I'm James, let's bond. Who cares, I'm awesome. Love me or hate me but you will never change me."}
          </Text>
          ...
          <View style={styles.statsContainer}>
            ...
            <TouchableOpacity style={styles.statBox}>
              <Text style={[styles.statValue, { color: theme.text }]}>
                {formatNumber(user?.followers || 125000)}
              </Text>
              <Text style={[styles.statLabel, { color: theme.textSecondary }]}>
                Followers
              </Text>
            ...
            <TouchableOpacity style={styles.statBox}>
              <Text style={[styles.statValue, { color: theme.text }]}>
                {formatNumber(user?.following || 125000)}
              </Text>
              <Text style={[styles.statLabel, { color: theme.textSecondary }]}>
                Following
              </Text>
          ...
          {isVisitor ? (
            <TouchableOpacity
              style={[styles.adCard, { borderColor: accentColor }]}
              activeOpacity={0.85}
              // onPress={() => router.push("/create-ad" as any)}
            >
              <View
                style={[
                  styles.adCardGradient,
                  { paddingVertical: 4, backgroundColor: accentColor },
                ]}
              >
                <View style={[styles.adCardContent, { marginLeft: 12 }]}>
                  <Text style={styles.adCardTitle}>
                    Subscribe for $19.90/mo
                  </Text>
                </View>
                ...
                <View style={[styles.adCardArrow, { height: 40, width: 40 }]}>
                  <Image
            ...
            <>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.85}
                onPress={() => router.push("/monetization" as Href)}
              >
                <View
                  style={[
                    styles.monetizationGradient,
                ...
                >
                  ...
                  <View style={styles.monetizationContent}>
                    <Text style={styles.monetizationTitle}>
                      Creator Monetization
                    </Text>
                    <Text style={styles.monetizationDesc}>
                ...
                <View style={styles.adCardGradient}>
                  ...
                  <View style={styles.adCardContent}>
                    ...
                    <Text style={styles.adCardDesc}>
                      Promote your content & reach more
                    </Text>
                  </View>
            ...
            <View style={styles.gridContainer}>
              {MOCK_POSTS.map((post, index) => (
                <TouchableOpacity
                  ...
                  onPress={() =>
                    router.push(`/video-feed?startIndex=${index}` as Href)
                  }
                  activeOpacity={0.9}
                >
                  <Image
      ...
      <Animated.View
        onLayout={(e) => {
          ...
          stickyHeaderAnim.setValue(-height); // fully hide initially
        }}
        style={[
          styles.stickyHeader,
          {
      ...
      >
          ...
          <View style={styles.stickyHeaderLeft}>
            <Image
              source={{
                uri:
                  user?.avatar ||
                  "https://images.unsplash.com/photo-1601814933824-fd0b574dd592?w=400&h=400&fit=crop",
              }}
            ...
            <View style={styles.stickyHeaderInfo}>
              <View style={styles.stickyHeaderNameRow}>
                ...
                />
                <Image
                  source={Images.psc_star}
                  style={{ height: 14, width: 14 }}
                />
              </View>
              <Text style={styles.stickyHeaderUsername}>
                @{user?.username || "jameswilson"}
              </Text>
            </View>
          </View>
        ...
        <View style={styles.stickyTabsContainer}>
          <View style={styles.stickyTabsRow}>
            <TouchableOpacity
              style={[
                styles.stickyTabItem,
                selectedTab === "shorts" && [
                  styles.stickyTabItemActive,
                  { backgroundColor: getColorWithOpacity(accentColor, 0.08) },
                ],
              ]}
              onPress={() => setSelectedTab("shorts")}
            >
              <Text style={[styles.stickyTabLabel, { color: accentColor }]}>
                Posts
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
        ...
        <View style={styles.stickySortRow}>
          <TouchableOpacity
            style={styles.stickySortBtn}
            onPress={() => setShowSortModal(true)}
          >
            <Image
              source={Images.arrow_up_down}
              style={{ height: 24, width: 24, tintColor: "#121212" }}
            />
                ...
                <View style={styles.floatingModalWrapper}>
                  {Platform.OS !== "web" ? (
                    <BlurView
                      intensity={8}
                      tint="dark"
                      style={styles.floatingModalBlur}
                    >
                      <View style={styles.floatingModalInner}>
                        ...
                        <ScrollView
                          style={styles.floatingModalContent}
                          showsVerticalScrollIndicator={false}
                        >
                        ...
                        >
                          <Text
                            style={[
                              ...
                              sortBy === "recent" && [
                                styles.floatingOptionTextActive,
                                { color: accentColor },
                              ],
                            ]}
                          >
                        ...
                        >
                          <View style={styles.floatingVisibilityLeft}>
                            ...
                            <View>
                              ...
                              <Text style={styles.floatingVisibilityDesc}>
                                Only you can see
                              </Text>
                            </View>
                          </View>
                ...
                {Platform.OS !== "web" ? (
                  ...
                  >
                    <View style={styles.floatingModalInner}>
                      ...
                      <View style={styles.floatingModalOptions}>
                        <Text style={styles.floatingColorSubtitle}>
                          Theme Mode
                        </Text>
                        <View style={styles.floatingThemeModeRow}>
                          <TouchableOpacity
                            style={[
                              ...
                              !isDarkMode && [
                                styles.floatingThemeModeOptionActive,
                                {
                                  backgroundColor: getColorWithOpacity(
                                    accentColor,
                                    0.16
                          ...
                          >
                            <Sun
                              size={20}
                              color={!isDarkMode ? accentColor : "#888"}
                              strokeWidth={2}
                            />
                            <Text
                              style={[
                          ...
                          {PROFILE_COLORS.map((color) => (
                            <TouchableOpacity
                              ...
                              style={[
                                ...
                                accentColor === color &&
                                  styles.floatingColorOptionSelected,
                              ]}
                              onPress={() => {
                                if (Platform.OS !== "web")
                                  Haptics.impactAsync(
