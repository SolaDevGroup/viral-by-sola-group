...
import { Bookmark, ChevronRight, Plus, X } from "lucide-react-native";
            ...
            <View style={styles.productTopRight}>
              <TouchableOpacity style={styles.iconButton} onPress={onFavorite}>
                <View
                  style={[
                    styles.favoriteIcon,
                    product.isFavorited && styles.favoriteIconActive,
                  ]}
                >
                  <Image
                    source={Images.star}
  ...
  return (
    <View style={styles.userSection}>
      <TouchableOpacity
        ...
        activeOpacity={0.7}
      >
        <AnimatedCircle size={44} style={{ margin: 14 }} duration={1000}>
        ...
        <View style={styles.userInfo}>
          ...
          <View style={styles.statsRow}>
            ...
            <Text style={styles.viewCount}>
              {formatTotalViews(user.totalViews)}
            </Text>
          </View>
        </View>
...
const NonProUserRow = ({ user, onPress }: NonProUserRowProps) => {
  return (
    ...
    >
      ...
      <TouchableOpacity
        style={styles.nonProMessageButton}
        onPress={() => console.log("Message non-pro user")}
      >
...
export default function ShopScreen() {
  ...
  const [selectedCategory, setSelectedCategory] =
    useState<(typeof SHOP_CATEGORIES)[number]>("Clothing");
