    ...
    <View style={styles.container}>
      <View style={[styles.header, { paddingTop: insets.top + 8 }]}>
        ...
        <View style={styles.headerActions}>
          ...
          >
            <Image
              source={isFavorited ? Images.heart_filled : Images.heart}
              style={{
                height: 22,
                width: 22,
                tintColor: isFavorited ? "#E53935" : "#121212",
              }}
            />
          </TouchableOpacity>
          <TouchableOpacity
      ...
      >
        ...
        <View style={styles.descriptionSection}>
          ...
          <Text style={styles.descriptionText}>
            High-quality {product.category.toLowerCase()} product from{" "}
            {product.brand}. This item has been viewed{" "}
            {formatViews(product.views)} times and is currently available for
            purchase. Direct from verified seller with fast shipping and buyer
            protection included.
          </Text>
        </View>
      </ScrollView>
