        ...
        >
          ...
          <View style={styles.sortContainer}>
            <TouchableOpacity
              style={[
                styles.sortButton,
                sortBy === "Most likes" && styles.sortButtonActive,
              ]}
            ...
            >
              <Text
                style={[
                  ...
                  sortBy === "Most likes" && styles.sortButtonTextActive,
                ]}
              >
                Most likes
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.sortButton,
                sortBy === "Most recent" && styles.sortButtonActive,
              ]}
            ...
            >
              <Text
                style={[
                  styles.sortButtonText,
                  sortBy === "Most recent" && styles.sortButtonTextActive,
                ]}
              >
                Most recent
              </Text>
