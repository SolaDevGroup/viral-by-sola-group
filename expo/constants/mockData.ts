...
export const MOCK_STORY_POSTS: StoryPost[] = [
  {
    ...
    type: "image",
    mediaUrl:
      "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=1080",
  ...
  },
  {
    ...
    type: "image",
    mediaUrl:
      "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=1080",
    caption: "Golden hour 🌅",
    createdAt: new Date(Date.now() - 3 * 60 * 60 * 1000).toISOString(),
    isViewed: false,
  },
  {
    ...
    type: "image",
    mediaUrl:
      "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=1080",
...
export const MOCK_CHAT_CONVERSATIONS = [
  ...
  },
  {
    ...
    user: {
      ...
      name: "Coca Cola",
      avatar:
        "https://images.unsplash.com/photo-1554866585-cd94860890b7?w=150&h=150&fit=crop",
      isBrand: true,
    },
    lastMessage: {
      id: "5",
...
export const MOCK_SHORTS: Short[] = [
  {
    ...
    thumbnailUrl:
      "https://images.unsplash.com/photo-1494790108377-be9c29b29330",
    caption: `Late night vibes under city lights 🌃 Sometimes the quiet moments say the most
Just breathing and letting life flow`,
    tags: ["fashion", "style"],
    soundName: "Summer Days",
    soundAuthor: "Chill Beats",
    likes: 8900,
...
export const MOCK_PRO_USERS: ProUser[] = [
  {
    ...
    username: "xboxus",
    avatar:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f9/Xbox_one_logo.svg/200px-Xbox_one_logo.svg.png",
    isVerified: true,
    isPro: true,
  ...
  },
  {
    ...
    username: "therealufc",
    avatar:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/9/92/UFC_Logo.svg/200px-UFC_Logo.svg.png",
    isVerified: true,
    isPro: true,
    totalViews: 85600000,
    products: [
...
export const DISCOVER_VIDEOS = [
  ...
  },
  {
    ...
    videoUrl:
      "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4",
    thumbnailUrl:
      "https://images.unsplash.com/photo-1569091491550-5e8d8b2b8a06",
    views: 167000,
    category: "Politics",
  },
  {
